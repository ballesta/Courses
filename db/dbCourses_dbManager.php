...
function getConnection() {
	...
	global $db_Courses_db_Url, $db_Courses_db_User, $db_Courses_db_Pass, $db_Courses_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_Courses_db_Url.";dbname=".$db_Courses_db_DbName, $db_Courses_db_User, $db_Courses_db_Pass);
